...
def esnPredict(n_reservoir, x_train, y_train, x_test, y_test) -> Tuple[float, Any, Any]:
    esn = ESN(n_inputs=x_train.shape[1], n_outputs=1, n_reservoir=n_reservoir)
    esn.fit(x_train.values.reshape(-1, x_train.shape[1]), y_train.values)
